...
Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.index', function (Generator $breadcrumbs) {
...
Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.import', function (Generator $breadcrumbs) {
...
Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.import.logs', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.testimonials.testimonials.index');
    $breadcrumbs->push(trans('cortex/testimonials::common.import'), route('adminarea.cortex.testimonials.testimonials.import'));
    $breadcrumbs->push(trans('cortex/testimonials::common.logs'), route('adminarea.cortex.testimonials.testimonials.import.logs'));
});

Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.create', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('adminarea.cortex.testimonials.testimonials.index');
...
Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.edit', function (Generator $breadcrumbs, Testimonial $testimonial) {
    $breadcrumbs->parent('adminarea.cortex.testimonials.testimonials.index');
...
Breadcrumbs::register('adminarea.cortex.testimonials.testimonials.logs', function (Generator $breadcrumbs, Testimonial $testimonial) {
    $breadcrumbs->parent('adminarea.cortex.testimonials.testimonials.index');
    $breadcrumbs->push(trans('cortex/testimonials::common.testimonial', ['id' => $testimonial->getRouteKey()]), route('adminarea.cortex.testimonials.testimonials.edit', ['testimonial' => $testimonial]));
