...
Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.index', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.import', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.import.logs', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.testimonials.testimonials.index');
    $breadcrumbs->push(trans('cortex/testimonials::common.import'), route('managerarea.cortex.testimonials.testimonials.import'));
    $breadcrumbs->push(trans('cortex/testimonials::common.logs'), route('managerarea.cortex.testimonials.testimonials.import.logs'));
});

Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.create', function (Generator $breadcrumbs) {
    $breadcrumbs->parent('managerarea.cortex.testimonials.testimonials.index');
...
Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.edit', function (Generator $breadcrumbs, Testimonial $testimonial) {
    $breadcrumbs->parent('managerarea.cortex.testimonials.testimonials.index');
...
Breadcrumbs::for('managerarea.cortex.testimonials.testimonials.logs', function (Generator $breadcrumbs, Testimonial $testimonial) {
    $breadcrumbs->parent('managerarea.cortex.testimonials.testimonials.index');
    $breadcrumbs->push(trans('cortex/testimonials::common.testimonial', ['id' => $testimonial->getRouteKey()]), route('managerarea.cortex.testimonials.testimonials.edit', ['testimonial' => $testimonial]));
